# ARCHIVED: Moon Tidal Station-Keeping Barbell (FAILED IDEA)

> [!WARNING]
> This project is archived. Detailed simulation and analysis showed that the magnitude of the third-body lunar gravity-gradient effect is far too small to yield practical orbit-raising or station-keeping benefits.

Prototype simulator for tidal station-keeping. It was designed to support both a
...
Instructions for rendering the passive diamond craft animation are in
[docs/diamond_passive_animation.md](docs/diamond_passive_animation.md).
